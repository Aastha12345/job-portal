 ...
 */
function peek$3(scanner, offset = 0) {
...
function consumeAttributeWithUnquotedValue(scanner) {
    const start = scanner.pos;
    if (consumeWhile(scanner, isUnquotedValue) && consume$2(scanner, 61 /* Equals */) && consumeIdent(scanner)) {
        return true;
    }
    scanner.pos = start;
    return false;
...
export { extractAbbreviation as extract, markup, parseAbbreviation as markupAbbreviation, parse$1 as parseMarkup, parse$2 as parseStylesheet, convertSnippets as parseStylesheetSnippets, resolveConfig, stringify$1 as stringifyMarkup, css as stringifyStylesheet, stylesheet, parse as stylesheetAbbreviation };
